...
graphonApp.run(function($rootScope){
    $rootScope.showBack = false;
    $rootScope.currentLanguage = 'pt';
});
*/
graphonApp.directive('editInPlace', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('editInPlaceVarName', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('editInPlaceValue', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('selectVariable', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('selectOperator', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('selectVariableBoot', function() {
  return {
    restrict: 'A',
...
graphonApp.directive('integer', function() {
  return {
    require: 'ngModel',
